    ...
    <nav class="main-header" aria-label="Global">
      <div class="header-content">
        <div class="header-left">
          ...
          <div class="">
            <button type="button" class="sidebar-toggle">
              <span class="sr-only">Admin Toggle Navigation</span>
        ...
        <div class="responsive-logo">
          <a class="responsive-logo-dark" href="{{ route ('dashboard') }}" aria-label="Brand"><img
              src="{{ asset('backend/assets/img/brand-logos/inf01.png') }}" alt="logo" class="mx-auto"></a>
          <a class="responsive-logo-light" href="{{ route ('dashboard') }}" aria-label="Brand"><img
              src="{{ asset('backend/assets/img/brand-logos/inf01.png') }}" alt="logo" class="mx-auto"></a>
        </div>
            ...
            <div class="header-nav-right">
              <div class="header-country hs-dropdown ti-dropdown hidden sm:block"
                ...
                <button id="dropdown-flag" type="button"
                  ...
                  <img src="{{ asset('backend/assets/img/flags/10.png') }}" alt="flag-img" class="h-[1.375rem] w-[1.375rem]">
                </button>
                  ...
                  <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                    <div class="py-2 first:pt-0 last:pb-0">
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/10.png') }}" alt="flag-img">
                          </div>
                          <div>
                      ...
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/1.png') }}" alt="flag-img">
                          </div>
                          <div>
                            <p class="text-xs font-medium">
                              Argentina
                      ...
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/2.png') }}" alt="flag-img">
                          </div>
                          <div>
                            <p class="text-xs font-medium">
                              Canada
                      ...
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/3.png') }}" alt="flag-img">
                          </div>
                          <div>
                            <p class="text-xs font-medium">
                              France
                      ...
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/4.png') }}" alt="flag-img">
                          </div>
                          <div>
                            <p class="text-xs font-medium">
                              Germany
                      ...
                      <div class="ti-dropdown-item">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                          <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                            <img src="{{ asset('backend/assets/img/flags/5.png') }}" alt="flag-img">
                          </div>
                          <div>
                            <p class="text-xs font-medium">
                              Italy
                    ...
                    <div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
                      <div class="ti-dropdown-item relative header-box">
                        <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                          <img loading="lazy" src="{{ asset('backend/assets/img/ecommerce/products/1.png') }}" alt="product-img"
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                          <img loading="lazy" src="{{ asset('backend/assets/img/ecommerce/products/2.png') }}" alt="product-img"
                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                          <div>
                            <p class="text-sm font-medium text-gray-800 dark:text-white">
                              Tshirt For Men
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                          <img loading="lazy" src="{{ asset('backend/assets/img/ecommerce/products/9.png') }}" alt="product-img"
                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                          <div>
                            <p class="text-sm font-medium text-gray-800 dark:text-white">
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                          <img loading="lazy" src="{{ asset('backend/assets/img/ecommerce/products/10.png') }}" alt="product-img"
                            class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                          <div>
                            <p class="text-sm font-medium text-gray-800 dark:text-white">
                    ...
                    <div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                      <div class="ti-dropdown-item relative header-box">
                        <a href="mail-inbox.html" class="flex space-x-3 rtl:space-x-reverse">
                          <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                            <img src="{{ asset('backend/assets/img/users/17.jpg') }}" alt="img" class="rounded-sm">
                          </div>
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="mail-inbox.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                          <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                            <img src="{{ asset('backend/assets/img/users/2.jpg') }}" alt="img" class="rounded-sm">
                          </div>
                          <div class="relative w-full">
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="mail-inbox.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                          <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                            <img src="{{ asset('backend/assets/img/users/21.jpg') }}" alt="img" class="rounded-sm">
                          </div>
                          <div class="relative w-full">
                      ...
                      <div class="ti-dropdown-item relative header-box">
                        <a href="mail-inbox.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                          <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                            <img src="{{ asset('backend/assets/img/users/11.jpg') }}" alt="img" class="rounded-sm">
                          </div>
                          <div class="relative w-full">
              ...
              <div class="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
                ...
                <div class="hs-dropdown-menu ti-dropdown-menu border-0 w-[20rem]" aria-labelledby="dropdown-profile">
                  ...
                  <div class="mt-2 ti-dropdown-divider">
                    ...
                    <a href="{{ route('logout') }}" class="ti-dropdown-item" onclick="event.preventDefault();
