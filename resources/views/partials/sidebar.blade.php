<div class="sidebar-wrapper" data-simplebar="true">
	...
	<ul class="metismenu" id="menu">
		...
		<li>
			...
			<ul>
				<li> <a href="{{ route('shoplist.index') }}"><i class='bx bx-radio-circle'></i>Shopping List</a>
				</li>
				<li> <a href="ecommerce-products.html"><i class='bx bx-radio-circle'></i>Products</a>
				</li>
				<li> <a href="ecommerce-products-details.html"><i class='bx bx-radio-circle'></i>Product Details</a>
				</li>
				<li> <a href="{{ route('unit.index') }}"><i class='bx bx-radio-circle'></i>Units</a>
				</li>
				<li> <a href="{{ route('unit.create') }}"><i class='bx bx-radio-circle'></i>Create Units</a>
				</li>
			</ul>
		</li>
		<li>
